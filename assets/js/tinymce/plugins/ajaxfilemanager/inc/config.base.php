...
////error_reporting(E_ALL ^ E_NOTICE);	
	...
	define("CONFIG_LOGIN_USERNAME", 'ssddffgdfgdgfdgsdfsdfg3454dsfb5e');
	define('CONFIG_LOGIN_PASSWORD', 'ASDFsqqww@#%JHGSDFGasdkjfh3812764ksdjfbhkjxcf');
	...
	//FILESYSTEM CONFIG
		...
		*/
	define('CONFIG_SYS_DEFAULT_PATH', (isset($_SESSION['fileManagePath']) ? $_SESSION['fileManagePath'] : '../../../../uploaded/') ); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', (isset($_SESSION['fileManagePath']) ? $_SESSION['fileManagePath'] : '../../../../uploaded/') );	//accept relative path only
	//define('CONFIG_SYS_DEFAULT_PATH', "../../../../../".$cnf->newsFolder);
	//define('CONFIG_SYS_ROOT_PATH', "../../../../".$cnf->newsFolder);
	...
	define('CONFIG_UPLOAD_MAXSIZE', 25000 * 1024 ); //by bytes
	//define('CONFIG_UPLOAD_MAXSIZE', 2048); //by bytes
	//define('CONFIG_UPLOAD_VALID_EXTS', 'txt');//

	define('CONFIG_EDITABLE_VALID_EXTS', 'txt'); //make you include all these extension in CONFIG_UPLOAD_VALID_EXTS if you want all valid
	
	define('CONFIG_OVERWRITTEN', false); //overwirte when processing paste
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,bmp,tif,zip,rar,gz,tar,mov,mpg,avi,asf,mpeg,wmv,aif,aiff,wav,mp3,swf,ppt,rtf,doc,docx,dot,dotx,pdf,txt,tex,ppt,pptx,xls,xlsx,ens,enl,flv,mp4,gjf');// // 
	...
	define("CONFIG_VIEWABLE_VALID_EXTS", 'gif,bmp,txt,jpg,png,tif,html,htm,js,css,xml,xsl,dtd,mp3,wav,wmv,wma,rm,rmvb,mov,swf,flv,mp4');
