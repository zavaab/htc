    ...
    <div class="sidebar">
      <div>
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="<?php echo base_url(); ?>assets/img/masters/<?php (isset($usrlogin['user']->img_user) ? $usrlogin['user']->img_user:"") ?>" class="img-circle elevation-2" alt="<?= $usrlogin['user']->first_name." ".$usrlogin['user']->last_name; ?>">
          </div>
          <div class="info">
