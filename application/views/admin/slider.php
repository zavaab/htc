...
/* preiview image */ /* override Bootstrap settings */
                   ...
                   <div class="form-group col-md-12">
						...
						<table class="table table-sm table-dark">
									...
									<tr>
										...
										data-whatever="@mdo"><i class="fas fa-tv"></i></button>
									...
									<div class="modal-dialog" role="document">
										...
										<p class="text-muted"><?= $slider->s_body;?> </p>
										</div>
										...
										?>assets/img/intro-carousel/<?= $slider->s_img;?>" alt="Snow" style="width:100%;max-width:100px" onclick="dispImage(<?= $i;?>)">
										...
										<td><?php
										if($slider->s_visible){
											echo '<button type="button" class="btn btn-sm btn-danger"><i class="fas fa-eye-slash"></i></button>';
										}else{
											echo '<button type="button" class="btn btn-sm btn-success"><i class="far fa-eye"></i></button>';
										}
										?>
										<button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModal_<?= $i;?>"
										data-whatever="@mdo"><i class="fas fa-edit"></i></button>
										<button type="button" class="btn btn-sm btn-warning" ><i class="fas fa-minus-circle"></i></button>
										</td>
