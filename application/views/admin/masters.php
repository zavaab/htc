                ...
                <div class="row">
                   ...
                   <div class="form-group col-md-12">
						...
						<table class="table table-hover table-bordered">
									...
									<tr>
										<td><?= $master->m_id;?></td>
										<td><?= $master->m_firstname;?></td>
										<td><?= $master->m_lastname;?></td>
										<td><?= $master->m_email;?></td>
										<td><?= $master->m_affiliation;?></td>
										<td>
									<img id="myImg_<?= $i;?>" src="<?php echo base_url();
									?>assets/img/masters/<?= $master->m_image;?>" alt="Snow"  style="width:100%;max-width:100px" onclick="dispImage(<?= $i;?>)">
									...
									<td><?php
										if($master->m_show){
											echo '<button type="button" class="btn btn-sm btn-danger">Not Show</button>';
										}else{
											echo '<button type="button" class="btn btn-sm btn-success">Show</button>';
										}
