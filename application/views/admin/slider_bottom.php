  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
							...
							<form id="addSlider_Form" action="<?php echo base_url()?>Admin/addSldierbt" method="POST" enctype="multipart/form-data">
											<div class="form-group">
												<label for="recipient-name" class="col-form-label">Title EN Slider :</label>
												<input type="text" class="form-control" id="recipient-name" name="title_slider_en" >
											</div>
											<div class="form-group">
												<label for="recipient-name" class="col-form-label">Title FA Slider :</label>
											...
											<div class="form-group">
												<label for="message-text" class="col-form-label">Text EN Slider :</label>
												<textarea class="form-control" id="message-text" name="text_slider_en"></textarea>
											</div>
											<div class="form-group">
												<label for="message-text" class="col-form-label">Text FA Slider :</label>
					...
					?>
						...
						<table class="table table-sm table-dark">
									...
									<div class="modal-dialog" role="document">
										...
										<a class="btn" rel="popover" data-img="<?php echo base_url();?>assets/img/slider_bottom/<?= $slider->s_img;?> " >Show Image</a>
										</td>
...
$('a[rel=popover]').popover({
  ...
  trigger: 'click',
  placement: 'top',
  content: function(){return '<img src="'+$(this).data('img') + '" style="width:350px;height:150px;" />';}
});
</script>
...
<script>
	function show(s_id) {
				$.ajax({
							url: "<?php echo base_url()?>Admin/showSbt",
							type: "POST",
							data:{s_id:s_id},
							success: function(result) {
								// console.log(result);
	...
	function notshow(s_id) {
			$.ajax({
							url: "<?php echo base_url()?>Admin/notshowSbt",
							type: "POST",
							data:{s_id:s_id},
							success: function(result) {
								// console.log(result);
